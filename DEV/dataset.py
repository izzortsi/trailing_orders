...
class Dataset:
    ...
    def storeRawCoinHistoricData(self, name, coin_name, data):
        ...
        with open(DATA_DIR + name + "_" + coin_name + '.json', 'w') as outfile:
    ...
    def loadRawCoinHistoricData(self, coin_name):
        ...
        with open(DATA_DIR + coin_name + '.json', ) as json_file:
    ...
    def loadCoinData(self,coin_name,months):
        ...
        for month in months:
            ...
            file_path = DATA_DIR + coin_name + '/' + month +"__"+ coin_name + '.json'
